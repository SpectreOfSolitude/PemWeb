    ...
    <div id="isi">
        ...
        <form class="login-wrapper" action="login.php" method="post">
            <div>
                ...
                <input type="text" placeholder="email or username" class="input-box" name="name"> 
            </div>
            <div>
            ...
            <label class="register-link">Don't have an account? <a id="register-here" href="{{ asset('register') }}"> Register
                    here</a></label>
        </form>
    </div>
